        ...
        <div className="row row--45 align-items-center">
          <div className="col-lg-6">
            <div className="banner-content">
              ...
              >
                Modern <span className="color-secondary">Figma UI/UX</span>{" "}
                Design with Frontline
              </h1>
              <p
                data-sal-delay="200"
                data-sal="slide-up"
                data-sal-duration="1000"
              >
                Learn UI design, UX research, prototyping, and design systems
                using Figma. Build real-world projects and create a job-ready
                portfolio.
              </p>
              <div
          ...
          <div className="col-lg-6">
            <div className="banner-gallery">
              <div
                ...
                data-sal-duration="1000"
              >
                <img src="/assets/images/banner/ui.jpg" alt="Girl Image" />
              </div>
              <div
                ...
                data-sal-duration="1000"
              >
                <img src="/assets/images/banner/ux.png" alt="Man Image" />
              </div>
              <div
