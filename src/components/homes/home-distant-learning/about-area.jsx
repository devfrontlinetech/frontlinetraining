        ...
        <div className="row g-5 align-items-center">
              ...
              <div className="author-box">
                <div className="inner">
                  ...
                  <div className="content">
                    <h4 className="title">R R Anbuthane</h4>
                    <p>
                      Figma Instructor with 8+ years of industry experience.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-5">
            <div className="about-content">
              ...
              >
                <span className="pre-title">About Our Design Hub</span>

                <h2 className="title">
                  Transforming Careers Through{" "}
                  <span className="color-secondary">Figma UI/UX Mastery</span>
                </h2>
                ...
                <p>
                  With a decade of experience in design education, we empower
                  students to create intuitive digital experiences. From
                  beginner fundamentals to advanced interaction design, our
                  hands-on approach prepares you for real-world UI/UX careers.
                </p>
              </div>
              <ul
