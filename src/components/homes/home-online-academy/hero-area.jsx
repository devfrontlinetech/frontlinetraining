    ...
    return (
        <div className="hero-banner hero-style-4 bg-image">
            ...
            <div className="banner-gallery">
                <Thumbnail num={'1'} slide={'slide-up'} img={'soft01.jpg'} />
                <Thumbnail num={'2'} slide={'slide-down'} img={'soft02.jpg'} />
                <Thumbnail num={'3'} slide={'slide-right'} img={'soft03.jpg'} />
                <div className="online-support" data-sal-delay="600" data-sal="slide-right" data-sal-duration="1000">
                    <div className="inner">
                        ...
                        <div className="content">
                            ...
                            <h4 className="title"><a href="tel:+91 97 89 65 54 55">+91 97896 55455</a></h4>
                        </div>
                    </div>
                </div>
            </div>
