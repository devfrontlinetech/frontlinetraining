                ...
                <div className="row g-5 align-items-center">
                    <div className="col-lg-5">
                        <div className="about-content">
                            <div className="section-title section-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span className="pre-title">DIGITAL MARKETING</span>
                                <h2 className="title">We Providing The <span className="color-secondary">Best Quality</span>Courses.</h2>
                                <span className="shape-line"><i className="icon-19"></i></span>
                                <p> Our mission is to make education accessible and engaging for everyone, regardless of their background or location. With a team of experienced instructors and industry experts, we curate courses that combine practical knowledge with interactive learning experiences.</p>
                            </div>
                    ...
                    <div className="col-lg-7">
                        <div className="about-image-gallery">
                            <img className="main-img-1" src="/assets/images/about/abt-01.jpg" alt="About Image" />
                            <img className="main-img-2" src="/assets/images/about/abt-02.jpg" data-sal-delay="150" data-sal="slide-down" data-sal-duration="800" alt="About Image" />
