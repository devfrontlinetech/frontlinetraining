export default function handler(req, res) {
  res.status(200).json([
    ...
    },
    {
      ...
      date: "Feb 15, 2026",
      comment: 15,
      sm_desc: 'Discover simple strategies to keep your morning workouts exciting, consistent, and effective.',
      delay:'200',
      home_1:true,
    },
    {
      ...
      date: "Mar 05, 2026",
      comment: 12,
      sm_desc: 'Explore practical tips to refresh your fitness routine and stay motivated with new techniques.',
      delay:'300',
      home_1:true,
    }
  ])
