                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Copyright {new Date().getFullYear()} <a href="https://frontlinetraining.in" rel="noreferrer" target="_blank"  aria-label="Read more about Seminole tax hike">Frontlinetraining</a> Designed By <a href="https://frontlinetechnologies.org/" rel="noreferrer" target="_blank"  aria-label="Read more about Seminole tax hike">Frontline</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
