...
const footer_contents = {
    desc: 'We provide industry-focused training programs designed to help students and professionals build real-world skills in web development, UI/UX design, and digital technologies.',
                                ...
                                <div className="inner">
                                    ...
                                    <div className="widget-information">
                                        <ul className="information-list">
                                            ...
                                            <li><span>Email:</span><a href="info@frontlinetraining.in"
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Copyright {new Date().getFullYear()} Frontlinetraining Designed By <a href="https://frontlinetechnologies.org/" target="_blank" rel="noreferrer" aria-label="Frontlinetraining">Frontline</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
